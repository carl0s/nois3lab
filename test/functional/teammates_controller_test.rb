...
class TeammatesControllerTest < ActionController::TestCase
  ...
  test "should create teammate" do
    assert_difference('Teammate.count') do
      post :create, teammate: { bio: @teammate.bio, facebook: @teammate.facebook, fullname: @teammate.fullname, linkedin: @teammate.linkedin, twitter: @teammate.twitter }
    end
  ...
  test "should update teammate" do
    put :update, id: @teammate, teammate: { bio: @teammate.bio, facebook: @teammate.facebook, fullname: @teammate.fullname, linkedin: @teammate.linkedin, twitter: @teammate.twitter }
    assert_redirected_to teammate_path(assigns(:teammate))
  end
